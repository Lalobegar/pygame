# Timers
# Spawning obstacles with obstacle_movement function
# Player animation
# Obstacle animation
...
def obstacle_movement(obstacle_list):
    if obstacle_list: 
        ...
        # The next line makes a copy of the obstacle_list but
        # only copies the obstacle which are not too far to the left.
...
player_index = 0 # pick either one of the list above
